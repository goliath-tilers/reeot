...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.8.1 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target reeot_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(reeot_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/reeot_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for reeot"
    VERBATIM
)
